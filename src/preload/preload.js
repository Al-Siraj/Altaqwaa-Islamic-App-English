...
window.addEventListener('DOMContentLoaded', async (event) => {
  ...
  const pageFile = path.basename(parsedUrl.pathname);
  ...
  const tempSettings = fs.readJsonSync(path.join(App_Path, './data/tempSettings.json'));
  // variables font size
  ...
  if (settings?.dark_mode === false) {
    ...
    switch (pageFile) {
      ...
      case "quran.html":
        ...
        await quran(fs, path, App_Path, settings, tempSettings);
        break;
      ...
      case "adhkarTopic.html":
        ...
        let adhkarTopic = require('./preload_modules/adhkarTopic.js');
        await adhkarTopic(fs, path, App_Path, settings, tempSettings);
        break;
      ...
      case "hisnmuslim.html":
        ...
        await hisnmuslim(fs, path, App_Path, settings);
        break;
