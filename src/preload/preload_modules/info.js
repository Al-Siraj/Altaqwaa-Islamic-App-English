module.exports = async function info(ipcRenderer, shell) {
    ...
    let Sources_9 = document.getElementById('Sources_9');
    let Sources_10 = document.getElementById('Sources_10');
    ...
    Sources_2.addEventListener('click', e => {
        shell.openExternal('https://theclearquran.org/')
    });
    ...
    Sources_5.addEventListener('click', e => {
        shell.openExternal('https://www.hisnmuslim.com')
    });
    ...
    Sources_8.addEventListener('click', e => {
        shell.openExternal('https://github.com/quran/quran.com-frontend-next')
    });

    Sources_9.addEventListener('click', e => {
        shell.openExternal('https://github.com/rastikerdar/vazirmatn')
    });

    Sources_10.addEventListener('click', e => {
